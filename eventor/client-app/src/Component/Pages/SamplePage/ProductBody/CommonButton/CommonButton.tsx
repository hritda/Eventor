...
import {
  setNavId,
  setTabId,
} from "../../../../../ReduxToolkit/AddProductSlice";
...
;
  ...
  const handleFormValue = () => {
    console.log("handlign form values:",formValue.eventName);
    ...
    // }
    // if (
    //   formValue.initialCost !== "" &&
    //   formValue.initialPrice !== "" &&
    //   formValue.select !== "" &&
    //   formValue.productStocks !== ""
    // ) {
    //   dispatch(setNavId(5));
    // }
    // if (
  ...
  return (
    <>
      ...
      <div className="product-buttons">
        {navId > 1 && (
          <Btn className="me-2" onClick={() => handlePrevious()}>
